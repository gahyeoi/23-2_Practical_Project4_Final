...
<div class="container">
    ...
    <table>
        ...
        <tr>
            <td>기분</td>
            <td><input type="text" name="mood" value="<%= u.getMood()%>"/></td>
        </tr>
        <tr>
            <td>날씨</td>
            <td><input type="text" name="weather" value="<%= u.getWeather()%>"/></td>
        </tr>
        <tr>
            <td>내용</td>
            <td><textarea cols="70" rows="5" name="content"><%= u.getContent()%></textarea></td>
        </tr>
        <tr>
